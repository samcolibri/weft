//! XRetweet Node - Retweet a post on X/Twitter.
//!
...
#[derive(Default)]
pub struct XRetweetNode;

#[async_trait]
impl Node for XRetweetNode {
    ...
    async fn execute(&self, ctx: ExecutionContext) -> NodeResult {
        ...
        match resp {
            ...
            Ok(r) => {
                ...
                tracing::error!("X retweet error: {} - {}", status, text);
