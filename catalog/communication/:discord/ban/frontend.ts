...
export const discordBanNode: NodeTemplate = {
	type: 'DiscordBan',
	label: 'Discord Ban',
	...
	color: '#5865F2',
	category: 'Utility',
	tags: ['discord', 'ban', 'moderation', 'member'],
	fields: [],
	defaultInputs: [
		...
		{ name: 'deleteMessageSeconds', portType: 'Number', required: false, description: 'Delete messages from the last N seconds (0-604800)' },
	],
	defaultOutputs: [
