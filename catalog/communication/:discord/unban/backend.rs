//! DiscordUnban Node - Unban a user from a Discord guild.
//!
...
#[derive(Default)]
pub struct DiscordUnbanNode;

#[async_trait]
impl Node for DiscordUnbanNode {
    ...
    async fn execute(&self, ctx: ExecutionContext) -> NodeResult {
        ...
        match resp {
            ...
            Ok(r) => {
                ...
                tracing::error!("Discord unban error: {} - {}", status, text);
...
register_node!(DiscordUnbanNode);
