//! TelegramPinMessage Node - Pin a message in a Telegram chat.
//!
...
#[derive(Default)]
pub struct TelegramPinMessageNode;

#[async_trait]
impl Node for TelegramPinMessageNode {
    ...
    fn metadata(&self) -> NodeMetadata {
        NodeMetadata {
            ...
            inputs: vec![
                ...
                PortDef::new("disableNotification", "Boolean", false),
            ],
            outputs: vec![
    ...
    async fn execute(&self, ctx: ExecutionContext) -> NodeResult {
        ...
        let disable_notification = ctx.input.get("disableNotification").and_then(|v| v.as_bool()).unwrap_or(false);
        ...
        let url = format!("https://api.telegram.org/bot{}/pinChatMessage", bot_token);
...
register_node!(TelegramPinMessageNode);
