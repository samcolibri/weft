//! SlackKick Node - Remove a user from a Slack channel.
//!
...
#[derive(Default)]
pub struct SlackKickNode;

#[async_trait]
impl Node for SlackKickNode {
    ...
    async fn execute(&self, ctx: ExecutionContext) -> NodeResult {
        ...
        let resp = client.post("https://slack.com/api/conversations.kick")
