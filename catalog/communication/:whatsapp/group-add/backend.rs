//! WhatsAppGroupAdd Node - Add participants to a WhatsApp group.
...
pub struct WhatsAppGroupAddNode;

#[async_trait]
impl Node for WhatsAppGroupAddNode {
...
register_node!(WhatsAppGroupAddNode);
